<template>
    <div class="row">
        ...
        <div class="row button-row">
            ...
            <button
                class="btn btn-info slim-button"
...
export default {
    ...
    methods: {
        ...
        addTime(momentSpecifier) {
            this.setAndUpdate(
                new moment(this.startTime).add(1, momentSpecifier),
                new moment(this.endTime).add(1, momentSpecifier)
            );
        },
        ...
        thisX(momentSpecifier) {
            let start = moment()
                .startOf(momentSpecifier)
                .add(this.offsetHours, "hours");
            let end = moment()
                .endOf(momentSpecifier)
                .startOf("day")
                .add(this.offsetHours, "hours")
                .add(1, "day");
