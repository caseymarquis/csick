<template>
    <div>
        <slot v-bind:sortHelper="sortHelper" v-bind:sortedItems="sortedItems"></slot>
    </div>
</template>
<script>
export default {
    ...
    computed: {
        sortedItems() {
            ...
            if (h.sortFn) {
                ...
                ret.sort(
                    (a, b) =>
                        h.sortDirection * this.sortByGetFn(a, b, h.sortGetFn)
                );
            } else if (h.sortField) {
                let field = h.sortField;
                ret.sort(
                    (a, b) => h.sortDirection * this.sortByFieldFn(a, b, field)
                );
            }
